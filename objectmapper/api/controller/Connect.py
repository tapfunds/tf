...
def CreateTap():
    ...
    req = requests.post(url=f"{PLAID_SERVICE}/api/v1/identity", data={"access_token": "access-sandbox-1ebc4747-dde5-4ec0-b2ef-0c69983b9362"})
    ...
    req2 = requests.post(url=f"{PLAID_SERVICE}/api/v1/plaid/item", data={"access_token": "access-sandbox-1ebc4747-dde5-4ec0-b2ef-0c69983b9362"})
